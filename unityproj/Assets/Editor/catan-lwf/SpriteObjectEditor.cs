...
namespace catan {
  namespace lwf {
    [CustomEditor(typeof(SpriteObject))]
    public class SpriteObjectEditor : Editor {
      private SpriteObject _lwfObject;
      private GameObject _gameObject;
      private SpriteFileList _fileList;
      private int _fileSelectIndex;
      //
      void OnEnable() {
        if (target != null) {
          _lwfObject = (SpriteObject)target;
          _gameObject = _lwfObject.gameObject;
          _fileList = new SpriteFileList("Resources");
      ...
      public override void OnInspectorGUI() {
        ...
        EditorGUILayout.BeginHorizontal();
        {
          _lwfObject.renderType = (SpriteObject.RenderType)EditorGUILayout.EnumPopup("Renderer", _lwfObject.renderType);
        }
        EditorGUILayout.EndHorizontal();
    ...
    internal class SpriteFileList {
      private string _basedir;
      private string[] _files;
      public string[] files {
        get { return _files; }
      }
      public SpriteFileList(string basedir) {
